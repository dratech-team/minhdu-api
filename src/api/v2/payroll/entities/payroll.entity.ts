import {AbsentSalary, Contract, Employee, Payroll, Salary, SalarySetting, Salaryv2} from "@prisma/client";
...
} & { salaries: FullSalary[], salariesv2?: Salaryv2[], absents?: (AbsentSalary & { setting?: SalarySetting }) [] };
